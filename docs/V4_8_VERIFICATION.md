...
[32m[32m[1m19 passed[0m[32m in 2.83s[0m[0m
...
## Production-mode manual checks

Verified in this build pass:

```text
ENVIRONMENT=production JWT_SECRET_KEY=change-me -> security_check exits 1
ENVIRONMENT=production JWT_SECRET_KEY=strong-production-secret-for-local-test -> security_check exits 0
```

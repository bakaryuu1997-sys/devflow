...
[32m[32m[1m25 passed[0m[32m in 3.94s[0m[0m
...
POST /api/demo/reset
POST /api/auth/login
GET /api/auth/me with old token -> 200
POST /api/auth/logout with old token -> 200
GET /api/auth/me with old token -> 401
POST /api/auth/login again -> 200
new token is unique -> true
GET /api/auth/me with new token -> 200
GET /api/auth/audit with new token -> 200
```

...
def api_v11_8_signed_archive_checksum_handoff(profile_id: str = Query(default="core-risk"), db: Session = Depends(get_db)):
...
def api_v11_8_operator_checksum_quickstart_package(profile_id: str = Query(default="core-risk"), db: Session = Depends(get_db)):
